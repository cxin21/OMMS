import type { ExtractedFact, MemoryType, LLMExtractionInput, LLMExtractionOutput, LLMExtractionFact, LLMConfig } from "../../types/index.js";
...
export class LLMExtractor {
  ...
  private maxTextLength: number = 4000;
  ...
  configure(config: LLMConfig): void {
    ...
    this.logger.info("LLM Extractor configured", { 
  ...
  async extractFacts(input: LLMExtractionInput): Promise<LLMExtractionOutput> {
    ...
    const conversation = input.context.slice(0, this.maxTextLength);
