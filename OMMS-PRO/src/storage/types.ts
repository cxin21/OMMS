...
export interface ICacheManager {
  // 基础 CRUD
  get(uid: string): Promise<any | null>;
  set(memory: any): Promise<void>;
  delete(uid: string): Promise<void>;
  clear(): Promise<void>;
  has(uid: string): boolean;

  // 批量操作
  getMany(uids: string[]): Promise<Map<string, any>>;
  setMany(memories: any[]): Promise<void>;
  deleteMany(uids: string[]): Promise<void>;

  // 高级
  removeByFilter(filter: (memory: any) => boolean): Promise<number>;
  getTopByImportance(limit: number): Promise<any[]>;
