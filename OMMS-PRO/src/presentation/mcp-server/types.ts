...
// 从 types/config 重新导出 MCPServerConfig
export type { MCPServerConfig, MCPToolsConfig, MCPPerformanceConfig } from '../../types/config';

// 从 types/config 重新导出默认配置
import { DEFAULT_OMMS_CONFIG } from '../../types/config';
export const DEFAULT_MCP_CONFIG = DEFAULT_OMMS_CONFIG.mcp;
